...
public class Kayttoliittyma {
    ...
    public void tulostaArvosanajakauma() {
        ...
        System.out.println("Koepisteiden keskiarvo: " + this.rekisteri.koepisteidenKeskiarvo());
        System.out.println("Arvosanojen keskiarvo: " + this.rekisteri.arvosanojenKeskiarvo());
